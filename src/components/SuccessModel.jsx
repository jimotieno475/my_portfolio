      ...
      {showSuccess && (
        ...
        >
          ...
          >
            <button
              onClick={() => setShowSuccess(false)}
              className={`absolute top-4 right-4 p-1 rounded-full transition-colors ${isDarkMode
            ...
            className="w-16 mx-auto h-16 bg-green-500 rounded-full flex items-center justify-center mb-6">
