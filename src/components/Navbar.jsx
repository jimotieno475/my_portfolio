        ...
        <motion.nav
            ...
            <div className='max-w-7xl mx-auto flex items-center justify-between'>
                <motion.div whileHover={{ scale: 1.05 }} className="flex items-center space-x-2">
                    ...
                    <span className={`${isDarkMode ? "text-gray-500 text-lg ml-1" : "text-black-500 text-lg ml-1"}`}>Jim Dev</span>
                </motion.div>


                {/* desktop nav */}
                <div className="text-gray-500 hidden md:flex items-center gap-6">
