...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    await emailjs.send(
      "service_j97t4se",   // from EmailJS dashboard
      "template_l2rwo2i",  // from EmailJS dashboard
      {
        name: formData.name,
        email: formData.email,
        message: formData.message,
      },
      "DxOaIPCpp7G05CJ1M"    // from EmailJS account
    );
    ...
    // You could also make an error modal here if you want
  } finally {
    ...
    {/* background elements */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">  
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <TextInput
                                ...
                                whileTap={{scale:0.98}}className="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-blue-400 text-white py-4 rounded-xl text-sm uppercase tracking-wider font-medium transition-all duration-300 flex items-center justify-center space-x-2"
                        ...
                        <div className="space-y-4">
                            {CONTACT_INFO.map((info, index) => (
                                <motion.div
                                    ...
                                    variants={itemVariants}
                                    whileHover={{ x: 4 }}
                                    className={`flex items-center space-x-4 p-3 rounded-xl ${isDarkMode ? "bg-gray-800/30 hover:bg-gray-800/50" : "bg-gray-50/50 hover:bg-gray-80/50"} transition-all duration-300`}
                                >
                                    <div
                                    className={`p-3 rounded-lg ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {SOCIAL_LINKS.map((social)=>(
                                ...
                                whileTap={{scale:0.95}}
                                className={`flex items-center space-x-3 p-4 rounded-xl border transition-all duration-300 ${isDarkMode ? "bg-gray-800/50 border-gray-700 hover:border-gray-600" : "bg-white/80 border-gray-200 hover:border-gray-300"} ${social.color} ${social.bgColor}`}>
                                    <social.icon size={20}/>
            ...
            >
                ...
                >
                    <h3 className="text-xl font-medium">Prefer a quick call?</h3>
                    <p
