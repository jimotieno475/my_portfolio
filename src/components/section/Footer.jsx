...
const AnimatedGradientLine = () => (
  ...
  return (
      ...
      >
          ...
          >
              <div className={`absolute bottom-10 left-1/4 w-64 h-64 rounded-full blur-3xl opacity-0 ${isDarkMode ? "bg-blue-500" : "bg-blue-400"}`} />
                  ...
                  >
                      ...
                      <motion.div variants={itemVariants} className="space-y-4">
                          ...
                          <motion.p
                              ...
                              className={`text-base font-semibold ${isDarkMode ? "text-gray-400" : "text-gray-600"} max-w-md mx-auto mb-10`}
                          >
                      ...
                      >
                          <div className={`h-px w-16 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-200'}`}/>
                              <motion.div
                      ...
                      <motion.div variants={itemVariants} className="space-y-2">
                          <p className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>
                              © {new Date().getFullYear()}  Jim Dev. All rights reserved.
                          </p>
                          <p className={`text-xs ${isDarkMode ? 'text-gray-600' : 'text-gray-500'}`}>
                              Built with React/Vite & Framer Motion • Designed with care to the core
                          </p>
                      </motion.div>
