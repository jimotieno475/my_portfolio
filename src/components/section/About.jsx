  ...
  return (
    <section ref={sectionRef}
          ...
          <div className="max-w-6xl mx-auto relative z-10">
                      ...
                      <div className="space-y-8">
                          {JOURNEY_STEPS.map((step, index) => (
                              ...
                              >
                                  ...
                                  {/* content */}
                                  <div className={`flex-grow p-6 rounded-xl border transition-all duration-300 ${isDarkMode ? "bg-gray-800/50 border-gray-700 group-hover:border-gray-600 group-hover:bg-gray-800/70": "bg-white/50 border-gray-200 group-hover:border-gray-300 group-hover:bg-white"} backdrop-blur-sm`}>
              ...
              >
                  <motion.div variants={itemVariants} className="flex flex-col items-center space-y-5">
                      <p
