            ...
            {SKILLS_CATEGORY.map((category, categoryIndex) => (
                ...
                >
                    ...
                    <div className="flex items-center mb-6">
                        <div className={`p-3 rounded-xl ${isDarkMode ? "bg-gray-800" : "bgt-gray-100"
                          } mr-4`}>
                        ...
                        {category.skills.map((skill,skillind)=>(
                            <div key={skill.name} className="group">
                                ...
                                <div className={`h-2 rounded-full overflow-hidden ${isDarkMode ? "bg-gray-800" : "bg-gray-200"}`}>
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-white/20 rounded-full opacity-0 groupd-hover:opacity-100 transition-opacity duration-300" />
                                    </motion.div>
                                </div>
                            </div>
                        ))}
                  ...
                  <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-3">
                      {TECH_STACK.map((tech, index) => (
                          <motion.span
                              ...
                              className={`px-4 py-2 text-sm rounded-full border transition-all duration-300 ${isDarkMode ? "bg-gray-900 border-gray-700 text-gray-300 hover:boder-gray-600" : "bg-white border-gray-300 text-gray-700 hover:boder-gray-400"}`}
                          >
                              {tech}
                          </motion.span>
                      ))}
