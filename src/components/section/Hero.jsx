                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <div className="w-32 h-32 mx-auto relative">
                                    <motion.div
                                        ...
                                        className={`w-full h-32 rounded-2xl overflow-hidden border-4 relative z-20 ${isDarkMode ? "bg-gray-900" : "bg-gray-300"} shadow-2xl`}>
                                        <img src={PROFILE_PIC}
                                            alt="profile"
                            ...
                            <motion.div
                                ...
                                <motion.button whileHover={{ y: -2 }}
                                    ...
                                    className={`border ${isDarkMode ? "border-gray-700 hover:border-gray-600 text-gray-300" : "border-gray-700 hover:border-gray-600 text-gray-300"} px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300`}>
                                    Get in Touch
                                </motion.button>
                            </motion.div>
                            ...
                            <motion.div variants={itemVariants}
                                ...
                                {[
                                    ...
                                    <motion.a key={index}
                                        ...
                                        className={`p-3 rounded-full transition-colors ${isDarkMode ? "text-gray-400 hover:text-white hover:bg-gray-100" : "text-gray-600 hover:text-gray-900 hover:bg-gray-200"}`}>
                            ...
                            {/* Tech stack- mobile */}
                            <motion.div variants={itemVariants}
                                className="flex justify-center items-center space-x-6 text-xs uppercase tracking-widest flex-wrap mb-10">
                                    {/* added mb-10 */}
                    ...
                    <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
                        ...
                        className="text-left">
                            ...
                            className="flex gap-6 mb-8">
                                ...
                                whileTap={{scale:0.98}}
                                onClick={()=> scrollToSection('contact')}
                                className={`border ${isDarkMode? "border-gray-700 hover:border-gray-600 text-gray-600": "border-gray-300 hover:border-gray-400 text-gray-700"} px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300`}>
                                    Get in Touch
                                </motion.button>
                            </motion.div>
                        ...
                        className="flex justify-center lg:justify-end">
                            <div className="relative">
                              ...
                              <motion.div
                                  ...
                                  className={`w-80 h-96 relative z-20 rounded-3xl overflow-hidden border-4 ${isDarkMode ? "border-gray-800" : "border-gray-300"
                                      } shadow-2xl`}
                              >
                                  <img
                                      src={PROFILE_PIC}
                              ...
                              <motion.div
                                  ...
                                  className="absolute -inset-4 rounded-3xl border border-blue-500/30 mb-0"
                              />
                              ...
                              <motion.div
                                  ...
                                  className="absolute -inset-8 rounded-3xl border border-purple-500/20 mb-10"
                              />
                            </div>  
                        </motion.div>
                    </div>
